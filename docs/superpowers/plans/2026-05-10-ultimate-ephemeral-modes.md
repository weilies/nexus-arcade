...
1. **Locked AI spec:** `docs/games/hashattack/ai-algorithms.md` — algorithms are locked. Do NOT invent alternatives.
...
> "Run QA for Ultimate and Ephemeral mode implementation. Spec: `docs/superpowers/specs/2026-05-10-ultimate-ephemeral-modes-design.md` section 9. AI algorithm spec: `docs/games/hashattack/ai-algorithms.md`."
